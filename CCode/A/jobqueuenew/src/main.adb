...
procedure Main is
   ...
   c_small_step_55 : counter(2);
   c_small_step_57 : counter(2);
   ...
   procedure small_step_55;
   procedure small_step_57;
   ...
   procedure small_step_55 is
      t_vb : Float;
      rdy : boolean;
   begin
      c_small_step_55.decr(rdy);
      if (not rdy) then return; end if;
      t_vb := vb;
      vb := t_vb + 0.1;
      tq.put(small_step_time'access);
   ...
   procedure small_step_57 is
      rdy : boolean;
      t_vc : Float;
   begin
      c_small_step_57.decr(rdy);
      if (not rdy) then return; end if;
      t_vc := vc;
      vc := t_vc + 0.2;
      tq.put(small_step_time'access);
